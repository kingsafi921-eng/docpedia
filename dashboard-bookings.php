        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2><i class="fas fa-calendar-check" style="color: #28a745;"></i> Bookings</h2>
                ...
                <div class="card" style="border: none; border-radius: 15px; box-shadow: 0 5px 20px rgba(0,0,0,0.08);">
                    <div class="card-body" style="padding: 50px; text-align: center;">
                        <i class="fas fa-calendar-check" style="font-size: 64px; color: #ddd;"></i>
                        <h4 style="color: #666; margin-top: 20px;">No Bookings</h4>
                        <p style="color: #999;">No appointments have been booked yet.</p>
