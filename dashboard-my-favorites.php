        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h2><i class="fas fa-heart" style="color: #dc3545;"></i> My Favorites</h2>
                ...
                <div class="card" style="border: none; border-radius: 15px; box-shadow: 0 5px 20px rgba(0,0,0,0.08);">
                    <div class="card-body" style="padding: 50px; text-align: center;">
                        ...
                        <h4 style="color: #666; margin-top: 20px;">No Favorites Yet</h4>
                        <p style="color: #999;">You haven't added any favorites yet.</p>
